...
impl RegisterEntry {
    ...
    const fn winin() -> Self {
        RegisterEntry {
            ...
            flags: const {
                &[
                    Flag::new("Window 0 BG0 enable", 0, 1),
                    Flag::new("Window 0 BG1 enable", 1, 1),
                    Flag::new("Window 0 BG2 enable", 2, 1),
                    Flag::new("Window 0 BG3 enable", 3, 1),
                    Flag::new("Window 0 OBJ enable", 4, 1),
                    Flag::new("Window 0 Color special effect", 5, 1),
                    Flag::unused(6, 2),
                    Flag::new("Window 1 BG0 enable", 8, 1),
                    Flag::new("Window 1 BG1 enable", 9, 1),
                    Flag::new("Window 1 BG2 enable", 10, 1),
                    Flag::new("Window 1 BG3 enable", 11, 1),
    ...
    const fn winout() -> Self {
        RegisterEntry {
            ...
            flags: const {
                &[
                    Flag::new("Outside BG0 enable", 0, 1),
                    Flag::new("Outside BG1 enable", 1, 1),
                    Flag::new("Outside BG2 enable", 2, 1),
                    Flag::new("Outside BG3 enable", 3, 1),
                    Flag::new("Outside OBJ enable", 4, 1),
                    Flag::new("Outside Color special effect", 5, 1),
                    Flag::unused(6, 2),
                    Flag::new("OBJ Window BG0 enable", 8, 1),
                    Flag::new("OBJ Window BG1 enable", 9, 1),
                    Flag::new("OBJ Window BG2 enable", 10, 1),
                    Flag::new("OBJ Window BG3 enable", 11, 1),
    ...
    const fn bldcnt() -> Self {
        RegisterEntry {
            ...
            flags: const {
                &[
                    Flag::new("BG0 1st Target", 0, 1),
                    Flag::new("BG1 1st Target", 1, 1),
                    Flag::new("BG2 1st Target", 2, 1),
                    Flag::new("BG3 1st Target", 3, 1),
                    ...
                    Flag::new("BG0 2nd Target", 8, 1),
                    Flag::new("BG1 2nd Target", 9, 1),
                    Flag::new("BG2 2nd Target", 10, 1),
                    Flag::new("BG3 2nd Target", 11, 1),
