...
impl Bus for PpuRegister {
    ...
    fn write_byte(&mut self, address: u32, value: u8) {
        match address % 0x0400_0000 {
            ...
            0x040 => self.winh[0].x2 = value,
            0x041 => self.winh[0].x1 = value,
            0x042 => self.winh[1].x2 = value,
            0x043 => self.winh[1].x1 = value,
            0x044 => self.winv[0].y2 = value,
            0x045 => self.winv[0].y1 = value,
            0x046 => self.winv[1].y2 = value,
            0x047 => self.winv[1].y1 = value,
